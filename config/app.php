...
if(isset($_ENV['DATABASE_URL'])) {
    $db_opt = parse_url($_ENV['DATABASE_URL']);
    $db_opt['database'] = ltrim($db_opt["path"],'/');
}
...
return [
     ...
     */
    'Security' => [
        'salt' => '796553e4dcca87dfcadbcef23f6b89f654b09d4e0a89621823260e20d8444796',
    ],
    ...
    'Datasources' => [
        'default' => [
             ...
             */
            'port' => $db_opt['port'],
            'username' => $db_opt['user'],
            'password' => $db_opt['pass'],
            'database' => $db_opt['database'],
            'encoding' => 'utf8',
            'timezone' => 'UTC',
            'cacheMetadata' => true,
